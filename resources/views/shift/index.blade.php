...
<html>
    ...
    <div class="form-container">
        <font color=blue><a href="{{ route('shift.create') }}" class="btn btn-secondary">新建班表</a></font>
        <font color=blue><a href="{{ route('shift.edit',['id'=>1]) }}" class="btn btn-secondary">修改班表</a></font>
    </div>
    @endguest
